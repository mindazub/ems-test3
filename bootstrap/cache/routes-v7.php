  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\ProfileController@updateSettings',
        'controller' => 'App\\Http\\Controllers\\ProfileController@updateSettings',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\DeviceController@devicesByFeed',
        'controller' => 'App\\Http\\Controllers\\DeviceController@devicesByFeed',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'plants/{plant}/available-dates',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\PlantController@getAvailableDates',
        'controller' => 'App\\Http\\Controllers\\PlantController@getAvailableDates',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'plants.available-dates',
      ),
      'fallback' => false,
      'defaults' => 
      array (
