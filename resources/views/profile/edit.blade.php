                        ...
                        <form method="POST" action="{{ route('profile.update.settings') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="time_format" id="time_format" class="form-select rounded border-gray-300">
                                    <option value="24" {{ (auth()->user()->settings['time_format'] ?? '24') == '24' ? 'selected' : '' }}>24-hour</option>
                                    <option value="12" {{ (auth()->user()->settings['time_format'] ?? '24') == '12' ? 'selected' : '' }}>12-hour (AM/PM)</option>
                                </select>
                            </div>
