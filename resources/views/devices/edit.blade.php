                    ...
                    <form method="POST" action="{{ route('devices.update', $device) }}">
                            ...
                            <select name="main_feed_id" id="main_feed_id" class="form-select" required>
                                ...
                                @foreach ($mainFeeds as $feed)
                                    <option value="{{ $feed->id }}"
                                        {{ old('main_feed_id', $device->main_feed_id) == $feed->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="device_model" id="device_model" class="form-control" required
                                value="{{ old('device_model', $device->device_model) }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="device_status" id="device_status" class="form-control" required
                                value="{{ old('device_status', $device->device_status) }}">
                        </div>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" role="switch" id="parent_device"
                                name="parent_device"
                                {{ old('parent_device', $device->parent_device) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="parameters" id="parameters" class="form-control" rows="4">{{ old('parameters', json_encode($device->parameters, JSON_PRETTY_PRINT)) }}</textarea>
                        </div>
